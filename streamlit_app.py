...
xmin = st.slider("xmin", min_value=-100.0, value = -10)
xmax = st.slider("xmax", min_value=-100.0, value = 10)

ymin = st.slider("ymin", min_value=-100.0, value = -10)
ymax = st.slider("ymax", min_value=-100.0, value = 10)
